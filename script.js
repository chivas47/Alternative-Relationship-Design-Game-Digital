        ...
        function exportAnswers() {
            ...
            a.href = url;
            a.download = `relationship-game-${new Date().toISOString().slice(0, 10)}.json`;
            ...
            reader.onload = function(e) {
                try {
                    ...
                    if (data.responses && typeof data.responses === 'object') {
                        ...
                        alert('Invalid file: missing responses data.');
                    }
                } catch {
                    alert('Could not read file. Make sure it is a valid export file.');
                }
                event.target.value = '';
            };
